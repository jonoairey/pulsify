      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-12">
          <div className="p-8">
            <div className="flex items-center mb-4">
              <Briefcase className="w-8 h-8 text-[#4ecca3] mr-4" />
              ...
              <div className="col-span-2">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-[#4ecca3] rounded-full mr-2"></div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#4ecca3]">94%</div>
                    <div className="text-sm text-gray-600">Staff Satisfaction</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#4ecca3]">$2.1M</div>
                    <div className="text-sm text-gray-600">Annual Savings</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#4ecca3]">3 Months</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              <Settings className="w-6 h-6 text-[#4ecca3] mr-3" />
              <h3 className="text-xl font-bold">BuildRight Construction</h3>
            </div>
            <p className="text-gray-600 mb-4">
              RFID tracking deployed across 12 construction sites for tool and equipment management.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              <Box className="w-6 h-6 text-[#4ecca3] mr-3" />
              <h3 className="text-xl font-bold">Metro Retail Group</h3>
            </div>
            <p className="text-gray-600 mb-4">
              RFID inventory system implemented across 50 retail locations.
            </p>
            <div className="space-y-2">
              <div className="flex items-center">
                <div className="w-2 h-2 bg-[#4ecca3] rounded-full mr-2"></div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              <Calendar className="w-6 h-6 text-[#4ecca3] mr-3" />
              <h3 className="text-xl font-bold">Global Events Pro</h3>
            </div>
            <p className="text-gray-600 mb-4">
              RFID solutions for equipment tracking and attendee management.
            </p>
            <div className="space-y-2">
              <div className="flex items-center">
                <div className="w-2 h-2 bg-[#4ecca3] rounded-full mr-2"></div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Briefcase className="w-6 h-6 text-[#4ecca3]" />
                </div>
                <div className="ml-3">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Settings className="w-6 h-6 text-[#4ecca3]" />
                </div>
                <div className="ml-3">
